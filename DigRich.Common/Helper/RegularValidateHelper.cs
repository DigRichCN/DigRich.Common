...
namespace DigRich.Common.Helper {
    public partial class RegularValidateHelper {
        ...
        /// <param name="replaceStr">用来替换的字符</param>
        /// <returns></returns>
        public static string Replace(string inputStr, string patternStr, string replaceStr) {
            Regex regex = null;
        ...
        /// <param name="input">待验证的字符串</param>
        /// <returns>是否匹配</returns>
        public static bool IsNumString(string input) {
            string pattern = @"^\d+$";
            return IsMatch(input, pattern);
        }
        ...
        /// <returns></returns>
        public static List<string> MatchMobileNumber(string input) {
            string pattern = @"0?1[3456789]\d{9}";
        ...
        /// [手机号码：[可匹配"(+86)013325656352"，括号可以省略，+号可以省略，(+86)可以省略，手机号前的0可以省略；手机号第二位数可以是3、4、5、7、8中的任意一个]]
        /// </summary>
        /// <param name="input">待验证的字符串</param>
        /// <returns>是否匹配</returns>
        ...
        public static bool IsEmail(string input) {
            ////邮箱名以数字或字母开头；邮箱名可由字母、数字、减号、下划线组成；邮箱名（@前的字符）长度为3～18个字符；邮箱名不能以点号、减号或下划线结尾；不能出现连续两个或两个以上的点号、减号。
        ...
        /// <param name="input">待验证的字符串</param>
        /// <returns>是否匹配</returns>
        public static bool IsIDCardTW(string input)
        {
            //第一位数出生的县市
            //是用英文字母26个字母来分的
            //台北市为A
        ...
        /// <param name="input">待验证的字符串</param>
        /// <returns>是否匹配</returns>
        public static bool IsIDCardXG(string input)
        {
            string pattern = @"^[A-Z][0-9]{6}\([0-9A]\)$";
            return IsMatch(input, pattern);
        }
        ...
        /// <param name="input">待验证的字符串</param>
        /// <returns>是否匹配</returns>
        public static bool IsIDCardOM(string input)
        {
            string pattern = @"^[157][0-9]{6}\([0-9]\)$";
            return IsMatch(input, pattern);
        }
        ...
        public static bool IsIDCard(string input) {
            if (input.Length == 18)
                ...
                return (IsIDCardTW(input) || IsIDCardXG(input) || IsIDCardOM(input));
        }
        ...
        /// <returns></returns>
        public static string MobileOperator(string moblie) {
            //五位
            var m5 = moblie.Substring(0, 5);
            var dx5 = new List<string> { "17400", "17401", "17402", "17403", "17404", "17405" };
            ...
            //四位
            var m4 = moblie.Substring(0, 4);
            var yd4 = new List<string> { "1703", "1705", "1706" };
            var lt4 = new List<string> { "1704", "1707", "1708", "1709" };
            var dx4 = new List<string> { "1349", "1700", "1701", "1702", "17400", "17401", "17402", "17403", "17404", "17405" };
            if (yd4.Contains(m4)) {
                return "移动";
            }
            if (lt4.Contains(m4)) {
            ...
            //三位位
            var m3 = moblie.Substring(0, 3);
            var yd = "、134、135、136、137、138、139、147、148、150、151、152、157、158、 159、165、178、182、183、184、187、188、198、";
            var dx = "、133、1349、149、153、180、181、189、177、173、174、191、199、";
            var lt = "、130、131、132、140、145、146、155、156、166、167、185、186、175、176、";
            if (yd.Contains($"、{m3}、")) {
                return "移动";
            }
            if (dx.Contains($"、{m3}、")) {
